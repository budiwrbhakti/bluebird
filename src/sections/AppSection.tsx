        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-luxury-gold text-2xl font-bold tracking-wider">EVO BALI Ride</span>
            </div>
            ...
            <p className="text-luxury-platinum-muted text-lg mb-8 leading-relaxed">
              Download the EVO BALI Ride app to book rides, track your driver in real-time,
